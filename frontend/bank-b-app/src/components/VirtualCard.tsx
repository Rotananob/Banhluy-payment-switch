    ...
    <motion.div
      ...
      className={`relative w-full max-w-[420px] aspect-[1.586/1] rounded-3xl p-6 sm:p-7 flex flex-col justify-between overflow-hidden shadow-2xl cursor-pointer select-none ${
        isPurple
          ...
          : 'bg-gradient-to-br from-blue-600 via-blue-950 to-slate-950 border border-blue-400/30 shadow-blue-500/20'
      }`}
    >
      {/* Shimmer / Hologram Overlay */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_20%,rgba(255,255,255,0.18)_0%,transparent_50%)] pointer-events-none" />
