    ...
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          {/* Main Hero Card */}
          <div className="glass-card glow-card p-8 bg-gradient-to-br from-purple-900/40 via-slate-900/80 to-slate-950/90 border-purple-500/20">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div>
                <div className="text-xs uppercase font-semibold text-purple-400 tracking-wider mb-2 flex items-center gap-2">
                  <Sparkles size={16} />
                  <span>Bank B Cyber Account</span>
                </div>
                ...
                <div className="text-sm font-mono text-slate-400 mt-2">
                  Account: <span className="text-purple-300">{account?.accountNumber}</span>
                </div>
              </div>
        ...
        <div className="max-w-xl mx-auto glass-card p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-slate-400 mt-1">
              Transfer funds instantly between Bank B accounts with zero fees.
            </p>
          </div>

          <div className="mb-6 bg-purple-500/10 border border-purple-500/30 rounded-xl p-3 flex items-center justify-between">
            ...
            <button
              ...
              className="px-3 py-1 rounded bg-purple-600 text-white text-xs font-semibold hover:bg-purple-500 transition"
            >
              Select BB-00000002
            </button>
          </div>
      ...
      {activeTab === 'receive' && (
        <div className="max-w-xl mx-auto glass-card p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-slate-400 mt-1">
              Create an EMVCo-compliant KHQR payment payload. Scan from Bank A to
          ...
          {generatedQr && (
            <div className="bg-slate-950/80 border border-purple-500/30 rounded-2xl p-6 text-center">
      ...
      {activeTab === 'scan' && (
        <div className="max-w-xl mx-auto glass-card p-8">
          ...
          <div className="space-y-4">
            ...
            {decodedKhqr && (
              <form onSubmit={handlePayKhqr} className="mt-6 bg-slate-900/90 border border-purple-500/40 rounded-2xl p-6 space-y-4">
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-3 text-xs text-purple-200">
