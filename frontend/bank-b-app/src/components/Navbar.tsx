...
export const Navbar: React.FC<NavbarProps> = ({ onRefresh, refreshing }) => {
  ...
  return (
    <header className="border-b border-white/10 bg-purple-950/40 backdrop-blur-xl sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        {/* Brand */}
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-purple-600/20 border border-purple-500/40 flex items-center justify-center text-purple-400 shadow-lg shadow-purple-500/10">
            <Landmark size={22} />
          </div>
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="badge-bank-b">AMETHYST</span>
            </div>
