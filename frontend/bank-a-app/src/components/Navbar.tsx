    ...
    <header className="border-b border-white/10 bg-slate-950/70 backdrop-blur-2xl sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 rounded-2xl bg-blue-600/20 border border-blue-500/40 flex items-center justify-center text-blue-400 shadow-xl shadow-blue-500/10">
            <Landmark size={24} />
          </div>
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="badge-bank-a">BANHLUY</span>
            </div>
